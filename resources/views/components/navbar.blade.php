    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse justify-content-end d-none d-md-flex">
            <ul class="navbar-nav me-3">
                ...
                <li class="nav-item"><a class="nav-link text-white" href="{{ url('/kirim-aduan') }}">KIRIM ADUAN</a>
                </li>
    ...
    <div class="offcanvas-body d-flex flex-column justify-content-between p-0">
        <div>
            <ul class="nav flex-column text-end">
                ...
                <li class="nav-item border-bottom"><a class="nav-link py-3" href="{{ url('/kirim-aduan') }}">KIRIM
                        ADUAN</a></li>
