        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse justify-content-end d-none d-md-flex">
                <ul class="navbar-nav me-4">
                    ...
                    <li class="nav-item"><a
                            class="nav-link text-white fw-semibold me-1 {{ request()->is('aduan-umum') ? 'active' : '' }}"
                            href="{{ route('aduan-umum') }}">LIHAT ADUAN</a></li>
                    <li class="nav-item"><a class="nav-link text-white fw-semibold me-1"
                            href="{{ route('faq') }}">FAQ</a></li>
                </ul>
                <div class="d-flex align-items-center rounded px-3 py-1 mx-2"
                    style="background: linear-gradient(to right, #6826b4, #6826b4);">
                    <a href="{{ route('user-profile') }}"
                        class="d-flex align-items-center text-decoration-none text-dark">
                        <img src="{{ asset($profile_picture) }}" class=" profileImg rounded-circle me-1"
                            alt="User">
                        <div class="ms-2">
        ...
        <div class="offcanvas-body d-flex flex-column justify-content-between p-0">
            ...
            <div>
                ...
                <ul class="nav flex-column mb-4">
                    <li class="nav-item">
                        <a class="nav-link nav-mobile {{ request()->is('dashboard') ? 'active' : '' }} text-dark d-flex align-items-center px-3 pb-3 rounded-2 mx-2 fw-medium"
                            href="{{ route('dashboard') }}">
                            <i data-feather="home" class="text-dark fs-3 me-2" style="scale: 0.9;"></i> Home
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link nav-mobile {{ request()->is('kirim-aduan') ? 'active' : '' }} text-dark d-flex align-items-center px-3 pb-3 rounded-2 mx-2 fw-medium"
                            href="{{ route('kirim-aduan') }}">
                            <i data-feather="send" class="text-dark fs-3 me-2" style="scale: 0.9;"></i> Kirim Aduan
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link nav-mobile {{ request()->is('aduan-umum') ? 'active' : '' }} text-dark d-flex align-items-center px-3 pb-3 rounded-2 mx-2 fw-medium"
                            href="{{ route('aduan-umum') }}">
                            <i data-feather="file-text" class="text-dark fs-3 me-2" style="scale: 0.9;"></i> Lihat Aduan
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link nav-mobile text-dark d-flex align-items-center px-3 pb-3 rounded-2 mx-2 fw-medium"
                            href="#">
            ...
            <div class="border-top p-3 d-flex align-items-center bg-light">
                ...
                <a href="#" class="text-dark fs-5 ms-2"
