        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse justify-content-end d-none d-md-flex">
                <ul class="navbar-nav me-3">
                    ...
                    <li class="nav-item"><a class="nav-link text-white fw-semibold me-1" href=""
                            data-bs-toggle="modal" data-bs-target="#loginModal">FAQ</a></li>
                </ul>
                ...
                <div class="container d-flex flex-column align-items-center justify-content-center text-center vh-100">
                    ...
                    <a href="#formLapor" class="mt-3 animate__animated animate__fadeInUp animate__delay-2s">
                        <button type="button" class="btn btn-lg fw-bold shadow-sm px-4 py-2 text-light"
                            ...
                            style="background: linear-gradient(to right, #531fa7, #6826b4);" data-bs-toggle="modal"
                        ...
                        <div class="card h-100 shadow-sm border-0 hover-shadow transition">
                            <a href="" class="text-decoration-none" data-bs-toggle="modal"
                                ...
                                <div class="card-body text-center">
                                    ...
                                    <p class="text-muted small">Tempat untuk mengetahui tata cara penggunaan sistem dan
                                        FAQ</p>
                                </div>
                            </a>
                        </div>
            ...
            <div class="container">
                ...
                <div id="carouselResponsive" class="carousel slide my-4" data-bs-ride="carousel">
                    ...
                    <div class="carousel-indicators">
                        <button type="button" data-bs-target="#carouselResponsive" data-bs-slide-to="0"
                            class="active" aria-current="true" aria-label="Slide 1"></button>
                        <button type="button" data-bs-target="#carouselResponsive" data-bs-slide-to="1"
                            aria-label="Slide 2"></button>
                        <button type="button" data-bs-target="#carouselResponsive" data-bs-slide-to="2"
                    ...
                    <div class="carousel-inner">
                        ...
                        <div class="carousel-item">
                            <div class="card mx-auto shadow rounded-4 border-3 overflow-hidden carousel-card">
                                <img src="{{ asset('images/background.jpg') }}" class="d-block w-100"
                                    alt="Slide 3">
                            </div>
                        </div>
                    </div>
                    ...
                    <!-- Controls -->
                    <button class="carousel-control-prev" type="button" data-bs-target="#carouselResponsive"
                        data-bs-slide="prev">
                        <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                        <span class="visually-hidden">Sebelumnya</span>
                    </button>
                    <button class="carousel-control-next" type="button" data-bs-target="#carouselResponsive"
                        data-bs-slide="next">
