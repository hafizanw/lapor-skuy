...
@section('content')
    ...
    <ul class="nav nav-tabs mb-3">
        <li class="nav-item">
            <a class="nav-link active" href="{{ route('departemen-list-aduan') }}">Daftar Aduan</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="{{ route('departemen-list-history') }}">History</a>
        </li>
    </ul>
    ...
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-3 gap-2">
        ...
        <div class="btn-group align-self-end">
            <a href="{{ route('departemen-list-aduan', ['filterType' => 'terbaru']) }}">
              <button id="btnTerbaru" class="btn btn-outline-primary btn-sm">Terbaru</button>
            </a>
            <a href="{{ route('departemen-list-aduan', ['filterType' => 'teratas']) }}">
        ...
        <div class="row g-0 align-items-center">
          ...
          <div class="col">
            <div class="card-body py-3 px-3">
              ...
              <form id="complaintForm" method="GET" action="{{ route('departemen-aduan-detail') }}">
                @csrf
                <input type="hidden" name="complaint_id" id="complaint_id">
              </form>
            
              <div class="mt-3">
                <button class="btn btn-sm text-dark" style="padding: 2px 8px; background-color: #e8dff1;">Vote : 4</button>
                <button onclick="selesaikanComplaint({{ $data->complaint_complaint_id }})" class="btn btn-sm ml-2 text-light" style="background: linear-gradient(to right, #531DAB, #842FE3); padding: 2px 8px;">Selesaikan</button>
            </div>
