...
@section('content')
    ...
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-3 gap-2">
        ...
        <div class="btn-group align-self-end">
            <a href="{{ route('uptlab-aduan', ['filterType' => 'terbaru']) }}">
              <button id="btnTerbaru" class="btn btn-outline-primary btn-sm">Terbaru</button>
            </a>
            <a href="{{ route('uptlab-aduan', ['filterType' => 'teratas']) }}">
    ...
    <div class="card mb-3 shadow-sm border-0 rounded-3">
        <div class="row g-0 align-items-center">
          ...
          <form id="complaintForm" method="GET" action="{{ route('uptlab-selesaikan-aduan') }}">
            @csrf
