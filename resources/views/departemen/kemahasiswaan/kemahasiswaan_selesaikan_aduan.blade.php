...
<div class="container my-4">
    ...
    <div class="card shadow-sm border-0 mb-5">
        <div class="card-body">
            ...
            <form method="POST" action="{{ route('kemahasiswaan-selesaikan-aduan') }}" enctype="multipart/form-data">
                @csrf
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.getElementById('btnKonfirmasiOK').addEventListener('click', function() {
            // Submit form
            document.querySelector('form[action="{{ route('kemahasiswaan-selesaikan-aduan') }}"]').submit();
        });
    });
    </script>
@endpush
