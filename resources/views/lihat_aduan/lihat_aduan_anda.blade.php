...
@section('content')
    <div class="container py-4">
        ...
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-3 gap-2">
            <input id="inputSearch" type="text" class="form-control w-100 w-md-50" placeholder="Search..."
                value="{{ request('searchKeyword') }}" onkeydown="if (event.key === 'Enter') searchOnly()">
            <div class="btn-group align-self-end">
                <a href="{{ route('aduan-anda', ['filterType' => 'terbaru']) }}">
                    <button id="btnTerbaru" class="btn btn-outline-primary btn-sm">Terbaru</button>
                </a>
                <a href="{{ route('aduan-anda', ['filterType' => 'teratas']) }}">
            ...
            <div class="card mb-3 shadow-sm border-0 rounded-3">
                <div class="row g-0 align-items-center">
                    ...
                    <div class="col-auto text-center px-3 py-4 border-end">
                        <!-- Form Upvote -->
                        <form action="{{ route('aduan-anda') }}" method="POST" style="display:inline;">
                            @csrf
                    ...
                    <div class="col">
                        <div class="card-body py-3 px-3">
                            ...
                            <!-- Judul -->
                            <a href="#" onclick="submitComplaint({{ $data->complaint_complaint_id }})"
                            ...
                            <div class="d-flex flex-wrap align-items-center gap-2 text-muted small">
                                ...
                                <span class="ms-auto me-4"><i data-feather="message-square" class="text-dark fs-3"
                                        style="scale: 0.7;"></i>{{ $data->total_comments ?? 0 }}</span>
                            </div>
...
@push('script')
    <script>
        ...
        function searchOnly() {
            ...
            const url = `/aduan-anda?searchKeyword=${encodeURIComponent(keyword)}`;
