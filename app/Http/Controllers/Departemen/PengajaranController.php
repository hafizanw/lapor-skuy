...
class PengajaranController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('departemen.pengajaran.pengajaran_list_aduan', [
            'data' => $data,
            'datas' => $datas,
    ...
    public function selesaikanAduan(Request $request)
    {
        ...
        return view('departemen.pengajaran.pengajaran_selesaikan_aduan', [
            'datas' => $datas,
            'data' => $data,
    ...
    public function store(Request $request) {
        ...
        return redirect()->route('pengajaran-aduan');
    }
}
